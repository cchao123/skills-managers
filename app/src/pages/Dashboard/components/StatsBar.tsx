...
export const StatsBar: React.FC<StatsBarProps> = ({ skills, filterType, onFilterChange }) => {
  ...
  return (
    <div className="flex items-center justify-center gap-3 px-3 py-1.5 bg-[#f8f9fa] dark:bg-dark-bg-secondary rounded-lg border border-[#e1e3e4] dark:border-dark-border">
      <button
        onClick={() => onFilterChange('all')}
        className={`flex items-center gap-1.5 transition-all rounded-md px-2 py-1 ${
          filterType === 'all'
